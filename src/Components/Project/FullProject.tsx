...
import { getProjectT, projectType} from '../../Reducers/addNewPostReducer'
        ...
        <div>
                ...
                return(
                        <div className={style.fullProject}>
                            <div className={style.header}><h1 style={{fontSize:50}}>{item.header}</h1></div>
