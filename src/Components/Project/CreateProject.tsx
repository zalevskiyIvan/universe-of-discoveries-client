...
const CreateProject = () => {
  ...
  return (
    <div>
      <Form
        onFinish={onFinish}
        style={{ width: 500, marginLeft: 200, marginTop: 50 }}
      >
        <Form.Item
        ...
        <Form.Item
          rules={[{ required: true, message: "Введите цели проекта" }]}
          name="purpose"
        >
          <Input.TextArea placeholder="Цели проекта через запятую" />
        </Form.Item>
        <Form.Item
          rules={[{ required: true, message: "Введите задачи проекта" }]}
          name="tasks"
        >
          <Input.TextArea placeholder="Задачи проекта" />
        </Form.Item>
        <Form.Item
          rules={[{ required: true, message: "Введите актуальность проекта" }]}
          name="relevance"
        >
          <Input.TextArea placeholder="Актуальность проекта" />
        </Form.Item>
        <Form.Item
          rules={[{ required: true, message: "Введите выводы" }]}
          name="conclusions"
        >
          <Input.TextArea placeholder="Выводы" />
        </Form.Item>
        <Form.Item
          rules={[{ required: true, message: "Введите результаты проекта" }]}
          name="results"
        >
        ...
        <Form.Item
          rules={[
            { required: true, message: "Введите краткое описание проекта" },
          ]}
        ...
        <Form.Item
          rules={[{ required: true, message: "Введите участников проекта" }]}
          name="members"
        >
