    ...
    <BrowserRouter>
      <div className='App'> 
        ...
        <Switch>
          ...
          <Route path='/:subject/create-project' render={() => <CreateProject/>}/> 
          <Route path='/:subject/admins' render={() => <Admins/>}/> 
          <Route path='/:subject/events' render={() => <div><Menu/><PostsRender type='events' /></div>}/>
          <Route path='/:subject/project' render={() => <div><Menu/><PostsRender type='projects'/></div>}/>
          <Route path='/:subject/tasks' render={() => <div><Menu/><PostsRender type='tasks'/></div>}/>
          <Route path='/:subject/about' render={() => <div><Menu/><AboutUs/></div>}/>
          <Route path='/:subject/links' render={() => <div><Menu/><UserfulLink/></div>}/>
